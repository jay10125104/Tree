...
long long int start[100001];
long long int ending[100001];
long long int linear[200002];
struct seg
{
...
int main(){
    ...
    while(q--){
        ...
        if(x==1){
            ...
            cin>>x;
            x--;
            cout<<s.query(1,0,n-1,start[x],ending[x])/2<<endl;
        }
    }
     return 0;
}
